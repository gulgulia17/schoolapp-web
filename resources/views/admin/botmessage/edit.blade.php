    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('botmessage.update', $botmessage->id)}}" method="post">
                        @csrf
                        @method('PATCH')
                        <div class="form-group">
                            <label for="question">Question</label>
                            <input type="text" name="question" id="question" class="form-control @error('question') is-invalid @enderror"
                                value="{{$botmessage->question}}" placeholder="Enter value for question">
                                @error('question')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="reply" id="reply" class="form-control @error('reply') is-invalid @enderror"
                                value="{{$botmessage->reply}}" placeholder="Enter value for reply">
                                @error('reply')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
