    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <h5 class="card-title">Update Your Plan</h5>
                </div>
                <div class="card-body">
                    <form action="{{route('plans.update', $plan->id )}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                                value="{{$plan->name}}" placeholder="Enter name ex. 1 year @ 1000">
                                @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="desc" id="desc" class="form-control @error('desc') is-invalid @enderror"
                                value="" placeholder="Enter description" rows="5">{{$plan->desc}}</textarea>
                                @error('desc')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="features" id="features" class="form-control ckeditor" id="editor @error('features') is-invalid @enderror"
                                value="" placeholder="Enter features" rows="5">{!!$plan->features!!}</textarea>
                                @error('features')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="amount" id="amount" class="form-control @error('amount') is-invalid @enderror"
                                value="{{$plan->amount}}" placeholder="Enter amount">
                                @error('amount')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
