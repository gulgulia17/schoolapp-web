                    ...
                    <table id="table" class="table text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{asset($item->image)}}" width="200" height="300"></td>
                                <td>
                                    <a href="{{route('topfeatures.edit',$item->id)}}" class="btn btn-warning">Edit</a>

                                    <a href="#"
                                        onclick="event.preventDefault(); document.getElementById('{{$item->id}}delete').submit();"
                                        class="btn btn-danger">Delete</a>
                                    <form action="{{route('topfeatures.destroy',$item->id)}}" method="post"
